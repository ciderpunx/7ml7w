...
# board complete?
  # winner X -> X won!
  # winner O -> O won!
# any 2 length lines for us? Complete
# any 2 length lines of opponent? Block
# get centre square
# go anywhere
...
#
    ...
    # try a move
    # if it works return board
    # otherwise 
    #  own_2s = try_own_twos(player,board)
    #  if own_2s == board do
    #    opponent_2s = try_opponent_twos(player,board)
    #    if opponent_2s == board do
    #      if centre_free(board) do
    #        try_centre(board)
    #      else
    #        crappy_move(player,board)
    #      end
    #    else
    #      crappy_move(player,board)
    #    end
    ...
    #def try_strategy(strat, player, board) do
    #end
# Assumption: X always plays first
